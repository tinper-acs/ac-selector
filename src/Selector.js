        ...
        .then(response => {
          if (response.status === 1 && response.data !== null) {
            if (activeKey === '1') {
              ...
              _list = addFullAttr(_list, this.props.locale)
              this.setState({
                multiShowList: _list,
                staffPage: obj
              })
      ...
      <Modal
        ...
        <Modal.Body className={'selectModalBody'}>
          <div className={'selectContainer clearfix'}>
            <div className={'rc-s-left'} id={'user'}>
              <Tabs
                defaultActiveKey={'1'}
                  ...
                  <div className={'we-box'}>
                    <div className={'we-left'}>
                      <div className={'we-searchWrapper'}>
                        <input value={weLeftVal} onChange={this.weLeftSearch} type="text" className={'rc-s-search-sm'}/>
                        <Icon
                    ...
                    <div className={'we-r'}>
                      <div className={'we-searchWrapper'}>
                        <input type="text" value={weSearchVal} onChange={this.weSearchAc} onKeyUp={this.weSearchUp} className={'rc-s-search'}/>
                          <Icon
